...
# Inherit device quickconfig:
$(call inherit-product, device/xiaomi/sunny/quickconfig.mk)

# Inherit prebuild apps:
$(call inherit-product, device/xiaomi/sunny/prebuild-apps.mk)
